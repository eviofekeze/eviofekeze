...
I am experienced data scientist with expertise building **end-to-end statistics driven data science** solution for data products. I also have experience performing qualitative statistical driven research. My expertise include **developing, testing and deploying** machine learning models for **real life applications**. My expertise include implementing Agile methodologies and CI/CD pipeline in the software development life cycle(SDLC),  in a distributed and high performance computing environment. This repos contains some of the examples of my approach to applying data science to real life problems.
